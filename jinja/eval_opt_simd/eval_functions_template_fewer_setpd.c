...
{       
    ...
    for(int i = 0; i < n; i++){
        ...
        __m256d u_init = _mm256_set_pd((i==j+3+ 4*{{i}}? pade_coefs[1] : 0.0), (i==j+2+ 4*{{i}}? pade_coefs[1] : 0.0), (i==j+1+ 4*{{i}}? pade_coefs[1] : 0.0), (i==j+ 4*{{i}}? pade_coefs[1] : 0.0));
        __m256d v_init = _mm256_set_pd((i==j+3+ 4*{{i}}? pade_coefs[0] : 0.0), (i==j+2+ 4*{{i}}? pade_coefs[0] : 0.0), (i==j+1+ 4*{{i}}? pade_coefs[0] : 0.0), (i==j+ 4*{{i}}? pade_coefs[0] : 0.0));
