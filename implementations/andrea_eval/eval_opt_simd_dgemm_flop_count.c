...
{   
    ...
    for(int i = 0; i < n; i++){
        for(int j = 0; j < n; j+=4*1){
            
            int idx_0 = i*n + j + 4*0;
            __m256d a_0 = _mm256_load_pd(&A_2[idx_0]);
            

            
            __m256d u_init_0 = _mm256_set_pd((i==j+3+ 4*0? pade_coefs[1] : 0.0), (i==j+2+ 4*0? pade_coefs[1] : 0.0), (i==j+1+ 4*0? pade_coefs[1] : 0.0), (i==j+ 4*0? pade_coefs[1] : 0.0));
            __m256d v_init_0 = _mm256_set_pd((i==j+3+ 4*0? pade_coefs[0] : 0.0), (i==j+2+ 4*0? pade_coefs[0] : 0.0), (i==j+1+ 4*0? pade_coefs[0] : 0.0), (i==j+ 4*0? pade_coefs[0] : 0.0));
            

            
            __m256d u_tmp_0 = _mm256_fmadd_pd(pade_3, a_0, u_init_0);
            __m256d v_tmp_0 = _mm256_fmadd_pd(pade_2, a_0, v_init_0);
            

            
            _mm256_store_pd(&U[idx_0], u_tmp_0);
            _mm256_store_pd(&V[idx_0], v_tmp_0);
...
{       
    ...
    for(int i = 0; i < n; i++){
        for(int j = 0; j < n; j+=4*1){
            ...
            int idx_0 = i*n + j + 4*0;
            __m256d a2_0 = _mm256_load_pd(&A_2[idx_0]);
            __m256d a4_0 = _mm256_load_pd(&A_4[idx_0]);
            ...
            __m256d u_tmp_0 = _mm256_fmadd_pd(pade_3, a2_0, u_init_0);
            __m256d v_tmp_0 = _mm256_fmadd_pd(pade_2, a2_0, v_init_0);
            __m256d u_0     = _mm256_fmadd_pd(pade_5, a4_0, u_tmp_0);
            __m256d v_0     = _mm256_fmadd_pd(pade_4, a4_0, v_tmp_0);
            

            
            _mm256_store_pd(&U[idx_0], u_0);
            _mm256_store_pd(&V[idx_0], v_0);
...
{       
    ...
    for(int i = 0; i < n; i++){
        for(int j = 0; j < n; j+=4*1){
            ...
            __m256d a2_0 = _mm256_load_pd(&A_2[idx_0]);
            __m256d a4_0 = _mm256_load_pd(&A_4[idx_0]);
            __m256d a6_0 = _mm256_load_pd(&A_6[idx_0]);
            ...
            __m256d u_tmp1_0 = _mm256_fmadd_pd(pade_3, a2_0, u_init_0);
            __m256d v_tmp1_0 = _mm256_fmadd_pd(pade_2, a2_0, v_init_0);
            __m256d u_tmp2_0 = _mm256_fmadd_pd(pade_5, a4_0, u_tmp1_0);
            __m256d v_tmp2_0 = _mm256_fmadd_pd(pade_4, a4_0, v_tmp1_0);
            __m256d u_0      = _mm256_fmadd_pd(pade_7, a6_0, u_tmp2_0);
            __m256d v_0      = _mm256_fmadd_pd(pade_6, a6_0, v_tmp2_0);
...
{       
    ...
    for(int i = 0; i < n; i++){
        for(int j = 0; j < n; j+=4*1){
            ...
            __m256d a4_0 = _mm256_load_pd(&A_4[idx_0]);
            __m256d a6_0 = _mm256_load_pd(&A_6[idx_0]);
            __m256d a8_0 = _mm256_load_pd(&A_8[idx_0]);
            ...
            __m256d u_tmp2_0 = _mm256_fmadd_pd(pade_5, a4_0, u_tmp1_0);
            __m256d v_tmp2_0 = _mm256_fmadd_pd(pade_4, a4_0, v_tmp1_0);
            __m256d u_tmp3_0 = _mm256_fmadd_pd(pade_7, a6_0, u_tmp2_0);
            __m256d v_tmp3_0 = _mm256_fmadd_pd(pade_6, a6_0, v_tmp2_0);
            __m256d u_0      = _mm256_fmadd_pd(pade_9, a8_0, u_tmp3_0);
            __m256d v_0      = _mm256_fmadd_pd(pade_8, a8_0, v_tmp3_0);
